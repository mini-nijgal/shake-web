...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/cu.png",
    place: "Christ University",
    time: "(May, 2021 - present)",
    desp: "<li>I'm currently working as an Assistant professor, holding multiple titles like Batch coordinator (2021-2023), Internship Coordinator, etc.</li>",
  },
  {
  ...
  {
    title: "Assistant Professor",
    cardImage: "assets/images/experience-page/BharataMataCollege.png",
    place: "Bharatha Mata College",
    time: "2016-2018",
    desp: "<li>As an Assistant Professor, I was responsible for developing and delivering courses, advising students, conducting and participating in academic committees.</li><li>",
  },
];
